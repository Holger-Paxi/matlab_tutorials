# Shortcuts/keystrokes for *MATLAB Live Scripts* and *MATLAB Scripts*

## Run code

| Action                       | Shortcut               |
| ---------------------------- | ---------------------- |
| Run current section          | `Ctrl + Enter`         |
| Run section and move to next | `Ctrl + Shift + Enter` |
| Run entire Live Script       | `F5`                   |
...
| Action                | Shortcut                              |
| --------------------- | ------------------------------------- |
| New section           | Type `%%` or `Ctrl + Alt + Enter`       |
| Run current section   | `Ctrl + Enter`                        |
| Move between sections | `Ctrl + Up/Down` (depends on version) |

## Editing

| Action                         | Shortcut                                    |
| ------------------------------ | ------------------------------------------- |
| New line below current line    | `Enter`                                     |
| Toggle Code-Text               | `Alt + Enter`                               |
| Insert line above              | `Ctrl + Shift + Enter` (depends on version) |
| Comment selected lines         | `Ctrl + R`                                  |
| Uncomment selected lines       | `Ctrl + Shift + R`                          |
| Undo                           | `Ctrl + Z`                                  |
| Redo                           | `Ctrl + Y`                                  |
...
3. [`for_loop_exercise_A_ver_2_notebook.mlx`](week_06/for_loop_exercise_A_ver_2_notebook.mlx)
...
3. [`simple_sum_series_function.m`](week_06/simple_sum_series_function.m)
...
3. [`complex_sum_series_function.m`](week_06/complex_sum_series_function.m)
...
3. [`trapezoidal_n_divisions_function.m`](week_07/trapezoidal_n_divisions_function.m)
4. [`simpson_n_divisions_notebook.mlx`](week_07/simpson_n_divisions_notebook.mlx)
5. [`simpson_n_divisions_script.m`](week_07/simpson_n_divisions_script.m)
6. [`simpson_n_divisions_function.m`](week_07/simpson_n_divisions_function.m)
7. [`integration_comparison_notebook.mlx`](week_07/integration_comparison_notebook.mlx)
8. [`integration_comparison.m`](week_07/integration_comparison.m)
9. [`simpson_n_divisions_notebook_v2.mlx`](week_07/simpson_n_divisions_notebook_v2.mlx)
10. [`simpson_n_divisions_script_v2.m`](week_07/simpson_n_divisions_script_v2.m)
11. [`simpson_n_divisions_function_v2.m`](week_07/simpson_n_divisions_function_v2.m)
...
3. [`diff_step_size_function.m`](week_07/diff_step_size_function.m)
...
3. [`num_diff_second_deriv_function.m`](week_07/num_diff_second_deriv_function.m)
4. [`num_diff_second_deriv_results_notebook.mlx`](week_07/num_diff_second_deriv_results_notebook.mlx)
5. [`num_diff_second_deriv_results.m`](week_07/num_diff_second_deriv_results.m)
...
3. [`trapezoidal_rule_function.m`](week_08/trapezoidal_rule_function.m)
4. [`simpson_rule_notebook.mlx`](week_08/simpson_rule_notebook.mlx)
5. [`simpson_rule_script.m`](week_08/simpson_rule_script.m)
6. [`simpson_rule_function.m`](week_08/simpson_rule_function.m)
7. [`computations_single_func_notebook.mlx`](week_08/computations_single_func_notebook.mlx)
8. [`computations_single_func_script.m`](week_08/computations_single_func_script.m)
9. [`computations_multiple_n_entries_notebook.mlx`](week_08/computations_multiple_n_entries_notebook.mlx)
10. [`computations_multiple_n_entries_script.m`](week_08/computations_multiple_n_entries_script.m)
11. [`computations_multiple_n_func_entries_notebook.mlx`](week_08/computations_multiple_n_func_entries_notebook.mlx)
12. [`computations_multiple_n_func_entries_script.m`](week_08/computations_multiple_n_func_entries_script.m)
13. [`simpson_rule_notebook_v2.mlx`](week_08/simpson_rule_notebook_v2.mlx)
...
3. [`composite_trapezoidal_function.m`](week_08/composite_trapezoidal_function.m)
...
3. [`composite_simpson_function.m`](week_08/composite_simpson_function.m)
4. [`compute_simp_mult_dx_notebook.mlx`](week_08/compute_simp_mult_dx_notebook.mlx)
5. [`compute_simp_mult_dx_script.m`](week_08/compute_simp_mult_dx_script.m)
...
3. [`normal_dist_mult_limits_notebook.mlx`](week_08/normal_dist_mult_limits_notebook.mlx)
